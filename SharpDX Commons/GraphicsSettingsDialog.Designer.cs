namespace SharpDXCommons
{
	partial class GraphicsSettingsDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.MSAASelect = new System.Windows.Forms.ComboBox();
			...
			this.WindowedCheckBox.Location = new System.Drawing.Point(14, 149);
			...
			this.FullscreenWindowCheckBox.Location = new System.Drawing.Point(14, 172);
			...
			this.VSyncCheckBox.Location = new System.Drawing.Point(133, 149);
			...
			this.TripleBufferingCheckBox.Location = new System.Drawing.Point(133, 172);
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.MSAASelect);
			...
			// MSAASelect
			// 
			this.MSAASelect.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.MSAASelect.FormattingEnabled = true;
			this.MSAASelect.Location = new System.Drawing.Point(92, 100);
			this.MSAASelect.Name = "MSAASelect";
			this.MSAASelect.Size = new System.Drawing.Size(202, 21);
			this.MSAASelect.TabIndex = 6;
			// 
			// label4
			// 
			...
			this.label4.Text = "MSAA samples";
			// 
			// LaunchButton
			// 
			this.LaunchButton.Location = new System.Drawing.Point(196, 195);
		...
		private System.Windows.Forms.ComboBox MSAASelect;
